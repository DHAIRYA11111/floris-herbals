...
// Target: frontend/src/pages/Wishlist.js
const dirPath = path.join('frontend', 'src', 'pages');
const filePath = path.join(dirPath, 'Wishlist.js');
...
console.log("✅ Success: Created frontend/src/pages/Wishlist.js");
